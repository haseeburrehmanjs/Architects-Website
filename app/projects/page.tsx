        ...
        <div>
          <div className='w-[100%] mt-10 bg-gray-100 flex flex-wrap gap-10 items-center'>
            ...
            <div className='flex flex-col sm:gap-10 gap-7 p-4'>
              ...
              <div>
                <button className='btn py-3 px-8 bg-gray-900 text-white text-[14px] hover:bg-gray-400 hover:text-black flex gap-2 items-center'>ALL PROJECT <FaLongArrowAltRight /></button>
              </div>
            </div>
          </div>
          <div className='w-[100%] mt-10 bg-gray-100 flex flex-wrap gap-10 items-center'>
